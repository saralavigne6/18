(function($){
	function crateCommentInfo(obj){
		...
		el = el + "</div><div class='col-md-2'><span class='reply-btn' style='color:#0b6696;'>回复</span></div></div></div><div class='reply-list'>";
	...
	function createReplyComment(reply){
		var replyEl = "<div class='reply'><div><a href='javascript:void(0)' class='replyname' style='color:#0b6696;'>"+reply.replyName+"</a>:<a href='javascript:void(0)' style='color:#0b6696;'>@"+reply.beReplyName+"</a><span>"+reply.content+"</span></div>"
						+ "<p><span style='color:#0b6696;'>"+reply.time+"</span> <span class='reply-list-btn' style='color:#0b6696;'>回复</span></p></div>";
		return replyEl;
	}
	...
	function replyClick(el){
		el.parent().parent().append("<div class='replybox'><textarea cols='90' rows='50' placeholder='来说几句吧......' class='mytextarea1' ></textarea><span class='send' style='color:#0b6696;'>发送</span></div>")
